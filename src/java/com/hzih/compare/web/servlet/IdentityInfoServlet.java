...
public class IdentityInfoServlet extends HttpServlet {
    ...
    public void destroy() {
        ...
        if (identityQueryLogDao != null) {
            identityQueryLogDao = null;
        }
    }
    ...
    public void init() throws ServletException {
        ...
        identityQueryLogDao = (IdentityQueryLogDao) ctx.getBean("identityQueryLogDao");
        ...
        timer.schedule(new IdentityInfoTask(identityInfoDao,identityQueryLogDao), time, Long.parseLong(CompareConfigXml.getAttribute(CompareConfigXml.compare_minutes))* 1000L *60L);
//        timer.schedule(new IdentityInfoTask(identityInfoDao,identityQueryLogDao), time, 1000L *5L);
